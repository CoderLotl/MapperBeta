		...
		private void InitializeData()
		{
			...
			for(int i = 0; i < 5; i++)
			{
				...
				for (int j = 0; j < 5; j++)
				{
                    ...
                    newNode.LocationImage = picSerializer.UploadImageAsString(global::MapperBeta.Resources.tile_blank);
			...
			if(newMap.ShowDialog() == DialogResult.OK)
			{
				...
				for (int i = 0; i < height; i++)
				{
					...
					for (int j = 0; j < width; j++)
					{
						...
						newLocationNode.LocationImage = pictureSerializer.UploadImageAsString(global::MapperBeta.Resources.tile_blank);
				...
				for (int i = 0; i < locationNodes.Count; i++)
				{
					for (int j = 0; j < locationNodes[i].Count; j++)
					{
						if(locationNodes[i][j] != null && locationNodes[i][j].LocationImage != "")
						{
							...
							locationNodes[i][j].LocationImage = pictureSerializer.UploadImageAsString(global::MapperBeta.Resources.tile_blank);
